<template class="user-body">
	<view>
		...
		<view class=" mt20 mlr15"><view class="dx-btn dx-btn-big dx-btn-blue-o w-b100" @click="goto('/pages/user/register/index')">注册</view></view>
	</view>
</template>
			...
			formSubmit() {
				this.postAjax("/user/login", this.ruleform).then(msg => {
					if (msg.data.status == 2) {
						this.goto("/pages/user/index/index");
					}
				});
			},
			ajax() {
