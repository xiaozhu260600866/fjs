				...
				<view class="Utop plr20">
					<view class="Uinfo">
						...
						<view class="fc-white info">
							<p class="fs-16">{{data.user.userInfo.name}}</p>
							<p class="fs-15 Arial">{{data.user.userInfo.phone}}</p>
						</view>
					</view>
				</view>
			...
			<div class="stuff-sec bg-f">
				...
				<div class="sec-group">
					<div class="item" @click="goto('/pages/hospital/coupon/order-list/index?status=0',1)">
						<image src="https://fjs.doxinsoft.com/images/site/dis-icon12.png" />
						<p class="p">优惠券</p>
				...
				<div class="sec-group">
					<div class="item" @click="goto('/pages/hospital/coupon/lists/index',1)">
						<image src="https://fjs.doxinsoft.com/images/site/dis-icon03.jpg" />
						<p class="p">发布</p>
				...
				<div class="sec-group">
					<div class="item" @click="goto('/pages/hospital/coupon/cancel/index',1)">
						<image src="https://fjs.doxinsoft.com/images/site/dis-icon02.jpg" />
						<p class="p">核销</p>
						<p class="num fs-14 fc-6"></p>
					</div>
				</div>
				<div class="sec-group">
					<div class="item" @click="goto('/pages/hospital/info/index',1)">
						<image src="https://fjs.doxinsoft.com/images/site/dis-icon07.png" />
						<p class="p">基本信息</p>
						<p class="num fs-14 fc-6"></p>
					</div>
				</div>
