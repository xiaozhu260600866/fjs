...
<style>
.hospital_item .limg .img{width: 100px;height: 100px;display: flex;}
.hospital_item .rinfo .info{display: flex;align-content: space-between;height: 100px;}
.hospital_item .rinfo .location{align-content: center;}
</style>